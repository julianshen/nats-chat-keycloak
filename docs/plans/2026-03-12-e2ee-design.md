...
|---------|------|--------|---------|
| **e2ee-key-service** | `e2ee-key-service/` | **New** | 4 KV buckets, 12 NATS subject handlers, queue group `e2ee-key-workers` |
...
| **Confidentiality at rest** | No | Persist-worker decrypts before DB storage; DB stores plaintext |
...
| **Replay protection** | Partial | AAD includes timestamp; no sequence numbering |
